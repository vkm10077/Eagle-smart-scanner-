...
class MarketDataUnavailableError(
    ...
    """Raised when verified data is unavailable."""


class MarketDataValidationError(
    MarketDataError
):
    """Raised when FYERS data fails validation."""
...
class MarketDataService:
    """
    Live market-data layer for Eagle Smart Scanner.
    ...
    def resample_daily_to_weekly(
        ...
        """
        Create real weekly OHLCV from daily candles.

        No fake weekly data is generated.
        """
    ...
    def analyze_stock(
        ...
        *,
        ...
        """
        Main bridge between FYERS and technical scanner.
        """
        ...
        # Current Price must come from live quote,
        # not from a fabricated value.
        result[
            "current_price"
        ] = round(
            live_price,
    ...
    def scan_stocks(
        ...
        *,
        ...
        """
        Scan candidate/common stocks.

        Only STRONG BUY results are returned.
        """
