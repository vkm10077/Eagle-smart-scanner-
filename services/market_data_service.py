...
from scanners.technical_scanner import analyze_stock
...
class MarketDataService:
    """
    Verified market-data bridge for Eagle Smart Scanner.
    ...
    Pipeline:
        ...
        FYERS Quote
            ↓
        FYERS Historical Candles
            ↓
        Intraday / Swing Timeframe Preparation
            ↓
        Technical Scanner
            ↓
    ...
    def get_mode_market_data(
        ...
        *,
        ...
        cache_ttl = (
            self.INTRADAY_CANDLE_CACHE_SECONDS
            if normalized_mode
            == Config.MODE_INTRADAY
            else self.SWING_CANDLE_CACHE_SECONDS
        )
    ...
    def analyze_stock(
        ...
        *,
        ...
        if (
            ...
            raise MarketDataUnavailableError(
                "Live FYERS price is unavailable."
            )


        # Live quote is always the displayed current price.
        result[
            "current_price"
        ] = (
            round(
