...
class FyersService:
    """
    FYERS API v3 service used by Eagle Smart Scanner.
    ...
    - Live quotes
    - History API
    - Parsed OHLCV candles
    - Intraday 5m + 15m + Daily data
    - Swing Daily data
    - Latest price
    - Market depth
    """
    ...
    def _history_date_range(
        *,
        ...
        # ----------------------------------------------------
            ...
            # Provides roughly 240-250 trading-day candles.
            # Enough for EMA-200 + additional lookback.
            calendar_days = 365
