...
def get_current_file(
    ...
    """
    Return mode-specific current-day candidate file.
    """
    ...
    return Config.get_current_day_file(
        normalized_mode
    )
...
def get_previous_file(
    ...
    """
    Return mode-specific previous-day candidate file.
    """
    ...
    return Config.get_previous_day_file(
        normalized_mode
    )
...
def get_common_file(
    ...
    """
    Return mode-specific common-stock file.
    """
    ...
    return Config.get_common_stocks_file(
        normalized_mode
    )
...
def _stock_to_dict(
    ...
    """
    Convert RankedStock or dictionary into
...
def _prepare_candidates(
    ...
    """
    Normalize candidate list and remove duplicates.
    """
...
def save_current_day_candidates(
    ...
    *,
    ...
    """
    Save today's Top Sector × Top Stock candidates.
...
def archive_current_as_previous(
    *,
    ...
    """
    Archive the latest current-day candidate file
    into the previous-day file for the same mode.
    """
...
def rollover_if_new_day(
    *,
    ...
    """
    Archive last saved current candidates when
    stored trading date differs from today's IST date.
...
def calculate_common_stocks(
    ...
    Only symbols present in both lists survive.
    """
...
def build_and_save_common_stocks(
    *,
    ...
    """
    Read previous/current candidate files,
    calculate common stocks,
    save mode-specific common-stock file.
    """
