...
class NSESectorUniverseError(
    ...
    """
    Raised when NSE sector constituent
...
class NSESectorUniverseService:
    """
    Dynamic NSE sector universe loader.

    IMPORTANT:
    - No fixed NIFTY 500 universe
    - No fixed 500-stock list
    - Stocks are loaded from sector-index constituent files
    - Same stock can appear in multiple source indices
    - Final stock universe is normalized and de-duplicated
    ...
    def _download_universe(
        ...
        # ----------------------------------------------------
        # Remove duplicate symbol inside same sector
        # ----------------------------------------------------
