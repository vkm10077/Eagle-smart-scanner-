...
def build_sector_top_stocks(
    ...
    *,
    ...
    if not metrics_by_symbol:
        ...
        raise RuntimeError(
            (
                ...
                "are unavailable for this sector."
            )
        )
    ...
    for position, ranked_stock in enumerate(
        ranked_stocks,
        start=1,
    ):

        item = (
            ranked_stock.to_dict()
        )
...
def api_sector_top_stocks(
    ...
    """
    Returns Top 10 technically-ranked stocks
    of the selected sector.

    Important:
    - All Top 10 ranked stocks are returned.
    - STRONG BUY is not required to appear here.
    - Final STRONG BUY stocks are marked separately.
    """
...
# ==========================================================
# OPTIONAL QUERY-STYLE SECTOR API
# ==========================================================
